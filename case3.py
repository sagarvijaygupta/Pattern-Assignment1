...
if __name__ == '__main__':
	...
	print(confusion,"\n", accuracy,"\n", precision,"\n", recall,"\n", fmeasure)
	contour(w, w0, [training_data[0], training_data[1]], Norm, sys.argv, ["class1", "class2"], means12, meanCovs12, 2, W)
	...
	print(confusion,"\n", accuracy,"\n", precision,"\n", recall,"\n", fmeasure)
	contour(w, w0, [training_data[1], training_data[2]], Norm, sys.argv, ["class2", "class3"], means23, meanCovs23, 2, W)
	...
	print(confusion,"\n", accuracy,"\n", precision,"\n", recall,"\n", fmeasure)
	contour(w, w0, [training_data[2], training_data[0]], Norm, sys.argv, ["class3", "class1"], means31, meanCovs31, 2, W)
	...
	print(confusion,"\n", accuracy,"\n", precision,"\n", recall,"\n", fmeasure)
	contour(w, w0, training_data, Norm, sys.argv, ["class1", "class2", "class3"], means123, meanCovs123, 2, W)
